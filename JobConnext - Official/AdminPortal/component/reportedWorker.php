...
$worker_reportedQRY = "
                    ...
                    WHERE r.job_post_id = 0 ORDER BY r.date DESC
                ";

$worker_report = mysqli_query($conn, $worker_reportedQRY);
$hasReports = mysqli_num_rows($worker_report) > 0;
...
?>
        <div class="post-card" data-name="<?= htmlspecialchars(strtolower($fullname)) ?>" data-date="<?= $date ?>">
            ...
            <div class="reported-reason">
                <span class="reason-text"><strong>Reported Reason:</strong>
                    <?php
...
<?php
    ...
    echo '<div class="no-results" id="noResultsDefault">No workers have been reported yet.</div>';
}
?>