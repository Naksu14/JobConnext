    ...
    <div id="reportModal" style="height: auto">
        ...
        <div class="d-flex flex-column justify-content-start align-items-start gap-2 mb-1">
            ...
            <button type="button" class="btn btn-sm btn-outline-primary" onclick="document.getElementById('report_fileUpload').click()">
                Choose Files
            </button>
            <button id="attachedFile" type="button" style="display: none;">
            ...
            <span id="report_fileNames">No file selected</span>
        </div>
    </div>
