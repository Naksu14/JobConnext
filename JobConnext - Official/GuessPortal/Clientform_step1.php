...
<style>
    ...
    .form-check-label[for="Welder"] {
        background-color: #c4f0c4; /* Light green */
        color: #000;
    }

    .form-check-label[for="Electrician"] {
        background-color: #e5d4ff; /* Light purple */
        color: #000;
    }

    .form-check-label[for="TruckDriver"] {
        background-color: #e9f7a1; /* Light yellow-green */
        color: #000;
    }
    ...
    .form-check-label[for="Others"] {
        background-color: #ffdaf6; /* Light pink */
        color: #000;
    }
...
<div class="container-fluid pb-5">
            ...
            <div class="text d-flex flex-row justify-content-center align-items-center">
                <div class="flex-column justify-content-center align-items-center">
                    <img src="../Assets/image/ClientImg.png" alt="Worker_img" width="600px" height="600px">
                    <p class="poppins-regular text-center">Looking for worker</p>
                </div>
